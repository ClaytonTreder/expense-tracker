      ...
      <div>
        ...
        >
          <h4 style={{ margin: '0' }}>
            Monthly income:{' '}
            {budget?.income
              .map((e) => (e.amount ? e.amount * (e.occurrences ?? 1) : 0))
              .reduce((a, b) => a + b, 0)}
          </h4>
        </div>
        <div
          ...
          <h4 style={{ margin: '0' }}>
            ...
            {budget &&
              ...
              budget.income
                .map((e) => (e.amount ? e.amount * (e.occurrences ?? 1) : 0))
                .reduce((a, b) => a + b, 0) -
                expenses.map((e) => e.amount ?? 0).reduce((a, b) => a + b, 0) /
                  100}
          </h4>
        </div>
        <div
        ...
        >
          <h4 style={{ margin: '0' }}>
            Total Spent:{' '}
            {expenses &&
              expenses.map((e) => e.amount).reduce((a, b) => a + b, 0) / 100}
          </h4>
        </div>
        <div
          style={{
          ...
          {budget &&
            ...
            budget.categories?.map((cat) => (
              <>
                ...
                >
                  <div style={{ width: '32%' }}>{cat.title}</div>
                  <div style={{ width: '27%' }}>
                  ...
                  <div style={{ width: '27%' }}>
                    <u onClick={showExpenses(cat.title)}>
                      {expenses &&
                        expenses
                          .map((e) => (e.category === cat.title ? e.amount : 0))
                ...
                {shownExpense && shownExpense === cat.title && expenses && (
                  <>
                    <div
                      style={{
                        display: 'flex',
                    ...
                    {expenses
                      .filter(
                        (e) =>
                          cat.title === e.category &&
                          e.category === shownExpense
                      )
                      .map((e, i) => (
                        <div
                          key={i}
                        ...
                        >
                          ...
                          >
                            {new Date(e.addedOn).toLocaleDateString()}
                          </div>
                          <div
                            style={{
                              width: '20%',
